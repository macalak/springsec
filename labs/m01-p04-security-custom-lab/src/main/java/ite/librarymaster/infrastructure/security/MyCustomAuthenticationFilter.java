...
public class MyCustomAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        // TODO: 16 Construct custom token from request and use AuthenticationManager to authenticate it
        MyAuthenticationWithPinToken myAuthenticationToken = null;

        // TODO: 16 Authenticate token by Authentication Provider on behalf of Authentication Manager
