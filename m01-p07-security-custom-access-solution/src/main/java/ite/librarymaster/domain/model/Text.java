...
public abstract class Text extends Medium {
	...
	public Text(Long id, String catId, String title, String publisher, MediumAvailability availability, String project) {
		super(id, catId, title, availability, project);
